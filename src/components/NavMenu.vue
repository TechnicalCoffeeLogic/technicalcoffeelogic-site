          ...
          -->
                    ...
                    <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                        <div class="flex-shrink-0 flex items-center">
                            <img class="block lg:hidden h-8 w-auto" src="../assets/coffee-cup.svg" alt="Workflow">
                            <img class="hidden lg:block h-8 w-auto" src="../assets/coffee-cup.svg" alt="Workflow">>
                        </div>
                        <div class="hidden sm:block sm:ml-6">
                            <div class="flex space-x-4">
                                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                                <router-link to="/" class="px-3 py-2 rounded-md text-sm font-medium"
                                    :class="homeSelected">Home</router-link>

                                <router-link to="/projects" class="px-3 py-2 rounded-md text-sm font-medium"
                                    :class="projectsSelected">Projects</router-link>

                                <router-link to="/about" class="px-3 py-2 rounded-md text-sm font-medium"
                                    :class="aboutSelected">About</router-link>
            ...
            <div class="sm:hidden" :class="visible" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1">
                    ...
                    <router-link to="/projects" :class="projectsSelected"
                        class="block px-3 py-2 rounded-md text-base font-medium" @click="Visibility()">Projects
                    </router-link>

                    <router-link to="/about" :class="aboutSelected"
                        class="block px-3 py-2 rounded-md text-base font-medium" @click="Visibility()">About
                    </router-link>

                    <a href="https://medium.com/@technicalcoffeelogic" target="_blank"
